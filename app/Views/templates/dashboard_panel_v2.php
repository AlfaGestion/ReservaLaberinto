...
<head>
    ...
    <?php
    $inlineCssFiles = [
        ROOTPATH . 'assets/vendor/bootstrap/css/bootstrap.min.css',
        ROOTPATH . 'assets/css/styles-20260428.css',
        ROOTPATH . 'assets/css/admin-theme.css',
        FCPATH . 'assets/vendor/bootstrap/css/bootstrap.min.css',
        FCPATH . 'assets/css/styles-20260428.css',
        FCPATH . 'assets/css/admin-theme.css',
    ];
    $inlineCss = '';
    foreach ($inlineCssFiles as $inlineCssFile) {
        if (is_file($inlineCssFile)) {
            $candidateCss = file_get_contents($inlineCssFile);
            if ($candidateCss !== false && $candidateCss !== '') {
                $inlineCss = $candidateCss;
                break;
            }
        }
    }
