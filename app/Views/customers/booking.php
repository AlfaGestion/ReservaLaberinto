...
<div class="container">
    <div class="d-flex flex-column align-items-start justify-content-center">
        <div class="form-floating mb-1 mt-3" style="width: 100%;">
            <input type="text" name="code" id="code" class="form-control" value="" aria-label="date">
            <label for="code">Código</label>
        </div>

        <div style="width: 50%;" class="mb-3">
            <button type="button" class="btn" style="color: #fff; background-color: <?= isset($userData) ? $userData['secondary_color'] : '#0064b0' ?>;" id="searchBooking">Ver mi reserva</button>
        </div>
    </div>

    <div class="d-none mt-4" id="bookingCardContainer">
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="form-floating flex-nowrap mb-3 d-flex align-items-center justify-content-center flex-row">
                    <input type="number" class="form-control" name="telefono" id="telefono" placeholder="Ingrese el teléfono" aria-label="name" disabled>
